...
//{
//public:
//	void doAimbot(DriverManager& driver_manager, const std::uintptr_t& client);
//private:
//	my_Vector findClosest(const std::vector<my_Vector> playerPositions);
//	void MoveMouseToPlayer(my_Vector position);
//};
//
