...
//		my_Vector playerPosition = driver_manager.read_memory<my_Vector>(player.pCSPlayerPawn + offset::m_vOldOrigin);
//
...
//}
//
//my_Vector Aimbot::findClosest(const std::vector<my_Vector> playerPositions)
//{
...
//}
//
//void Aimbot::MoveMouseToPlayer(my_Vector position)
//{
